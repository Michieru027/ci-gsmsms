...
class Template
{
    ...
    /**
     * Put extra specific js, meta tags, etc after other head data
     *
     * @access	public
     * @param	 string	$line	The line being added to head
     * @return	void
    ...
    /**
     * Put extra specific css, meta tags, etc after other head data
     *
     * @access	public
     * @param	 string	$line	The line being added to head
     * @return	void
    ...
    public function UploadFolder($foldername){
        return base_url().'assets/uploads/'.$foldername.'/';
    }
    ...
    public function Vars($var){
        $MYController	=	new MY_Controller();
        $ArrayVariables	=	$MYController->TemplateVars();
        return $ArrayVariables[$var];
    }
}
